...
exports.initialize = function initializeDataSource(dataSource, callback) {
  ...
  // FIXME SETO
  // if (!(dataSource in OrigDestroyAll)) {
  //   OrigDestroyAll[dataSource] = dataSource.connector.destroyAll;
  //   dataSource.connector.destroyAll = myDestroyAll;
  // };
...
//   var whereClause = SqlConnector.prototype.buildWhere.apply(this, arguments);
//   if (whereClause.sql) {
//     whereClause.sql = whereClause.sql + ' ALLOW FILTERING';
//   }
//   console.log('~~~~~~~~~~~~~~~~~~~~~~~~ my buildWhere:', whereClause);
//   return whereClause;
// };
...
Cassandra.prototype._modifyOrCreate = function(model, data, options, fields, cb) {
  ...
  this.execute(sql.sql, sql.params, options, cb);
};
